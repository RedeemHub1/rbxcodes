...
export const seedGames: Game[] = [
  {
    ...
    imageUrl: "/images/games/blox-fruits.svg",
    accent: "#67f8c4",
    isFeatured: true,
    popularityRank: 1,
    updatedAt: now
  },
  {
    ...
    imageUrl: "/images/games/blue-lock-rivals.svg",
    accent: "#7c5cff",
    isFeatured: true,
    popularityRank: 2,
    updatedAt: now
  },
  {
    ...
    imageUrl: "/images/games/anime-vanguards.svg",
    accent: "#ffbf47",
    isFeatured: true,
    popularityRank: 3,
    updatedAt: now
  },
  {
    ...
    imageUrl: "/images/games/pet-simulator.svg",
    accent: "#38bdf8",
    isFeatured: true,
    popularityRank: 4,
    updatedAt: now
  },
  {
    ...
    imageUrl: "/images/games/blade-ball.svg",
    accent: "#f97316",
    isFeatured: true,
    popularityRank: 5,
    updatedAt: now
  },
  {
    ...
    imageUrl: "/images/games/fisch.svg",
    accent: "#22d3ee",
    isFeatured: true,
    popularityRank: 6,
    updatedAt: now
  },
  {
    ...
    imageUrl: "/images/games/grow-a-garden.svg",
    accent: "#84cc16",
    isFeatured: true,
    popularityRank: 7,
    updatedAt: now
  },
  {
    ...
    imageUrl: "/images/games/brookhaven.svg",
    accent: "#ec4899",
    isFeatured: true,
    popularityRank: 8,
    updatedAt: now
  },
  {
    ...
    imageUrl: "/images/games/king-legacy.svg",
    accent: "#eab308",
    isFeatured: true,
    popularityRank: 9,
    updatedAt: now
